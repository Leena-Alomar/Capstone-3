...
public class PromptBuilder {
    ...
    public String generateNewContentByUserName(CampaignContentDTO dto, String name) {

        String minAge = dto.getTargetAudienceMinAge() == null ? "" : dto.getTargetAudienceMinAge().toString();
        String maxAge = dto.getTargetAudienceMaxAge() == null ? "" : dto.getTargetAudienceMaxAge().toString();

        return """
        You are a content creator specialist required to create a content for this project campaign in a language based on the requesting user: %s.
        for example:
        
        Saudi name: generate content in Arabic.
        French name: generate content in French.
        Chines name: generate content in Chines.

        Generate a JSON object for a social media content to a project campaign according to the following details:
