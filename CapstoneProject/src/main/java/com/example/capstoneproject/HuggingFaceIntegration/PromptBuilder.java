...
public class PromptBuilder {
    ...
    public String evaluateContent(GeneratedContent content, CampaignContentDTO dto){
        return """
        You are a content creator working for this project campaign.
        Evaluate the provided social media content for effectiveness.
    ...
    public String trendBasedContentGeneration(CampaignContentDTO dto){
        ...
        Generate a JSON object for a social media content for a project campaign based on the latest trend of this platform according to the following details:
    ...
    public String checkForCulture(GeneratedContent content, String culture){
        return """
        You are a content creator specialist working for this project campaign.

        You are evaluating weather a content is suitable for a this culture %s.
